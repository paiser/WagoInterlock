/*----- PROTECTED REGION ID(WagoInterlockClass.h) ENABLED START -----*/
//=============================================================================
//
// file :        WagoInterlockClass.h
//
// description : Include for the WagoInterlock root class.
//               This class is the singleton class for
//                the WagoInterlock device class.
//               It contains all properties and methods which the 
//               WagoInterlock requires only once e.g. the commands.
//
// project :     
//
...
#ifndef WagoInterlockClass_H
#define WagoInterlockClass_H

#include <tango.h>
#include <WagoInterlock.h>


/*----- PROTECTED REGION END -----*/	//	WagoInterlockClass.h


namespace WagoInterlock_ns
{
/*----- PROTECTED REGION ID(WagoInterlockClass::classes for dynamic creation) ENABLED START -----*/


/*----- PROTECTED REGION END -----*/	//	WagoInterlockClass::classes for dynamic creation

//=========================================
//	Define classes for commands
//=========================================
//	Command UploadConfig class definition
...
/**
 *	The WagoInterlockClass singleton definition
 */

#ifdef _TG_WINDOWS_
class __declspec(dllexport)  WagoInterlockClass : public Tango::DeviceClass
#else
